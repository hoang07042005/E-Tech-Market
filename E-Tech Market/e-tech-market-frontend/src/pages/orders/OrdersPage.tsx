...
export default function OrdersPage() {
  ...
  return (
    <div className={inProfile ? 'odhWrap' : 'odPage'}>
      ...
      {loading ? (
        <div className={inProfile ? 'odhEmpty' : 'odEmpty'}>Đang tải…</div>
      ) : error ? (
                ...
                <table className="odhTable">
                  ...
                  <tbody>
                    {rows.map((o) => {
                      ...
                      return (
                        <tr key={o.id}>
                          <td className="odhCode">{o.order_code}</td>
                          <td className="odhDate">{fmtDateVi(o.created_at)}</td>
                          <td>
