...
import { me as fetchMe, logout as apiLogout } from '../../lib/auth'
import { API_BASE_URL, apiFetch } from '../../lib/api'
import { clearAuthSessionExpiry } from '../../lib/authSession'
...
function IconReceipt() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M6 2h12v20l-2-1-2 1-2-1-2 1-2-1-2 1V2Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M9 7h6M9 11h6M9 15h5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  )
}
...
function IconShield() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M12 2l8 4v6c0 5-3.4 9.4-8 10-4.6-.6-8-5-8-10V6l8-4Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M9.5 12.2l1.6 1.6 3.6-3.8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  )
}
...
function IconLogout() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M16 17 21 12 16 7" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <div className="pfInner">
          ...
          <div className="pfTopRow">
            ...
            <div>
              ...
              <div className="pfBadges">
                ...
                {/* <span className="pfBadge pfBadgeMuted">ID: {etId}</span> */}
              </div>
            </div>
        ...
        <section className="pfGrid" aria-label="Khu vực tài khoản">
          <aside className="pfSidebar">
            ...
            <button type="button" className="pfNavBtn pfLogoutBtn" onClick={logout}>
              <SideIconWrap>
                <IconLogout />
              </SideIconWrap>
              Đăng xuất
                    ...
                    <table className="pfTable">
                      ...
                      <tbody>
                        {orders.slice(0, 3).map((o) => (
                          <tr key={o.id}>
                            <td style={{ fontWeight: 900 }}>{o.order_code}</td>
