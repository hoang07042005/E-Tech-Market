...
```mermaid
flowchart TD
    subgraph ActorsWeb["🎭 Actors"]
        Guest["👤 Khách hàng<br/>(chưa đăng nhập)"]
        AuthUser["👤 Khách hàng<br/>(đã đăng nhập)"]
        Admin["👑 Admin"]
    end

    subgraph GuestUC["📋 Use Cases - Guest"]
        UC1["🏠 Xem trang chủ"]
        UC2["📂 Danh sách SP<br/>(theo category)"]
        UC3["🔍 Lọc/Tìm kiếm"]
        UC4["📱 Xem chi tiết SP<br/>(PDP)"]
        UC5["⚖️ So sánh sản phẩm"]
        UC6["🛒 Giỏ hàng"]
    end

    subgraph AuthUC["📋 Use Cases - Auth"]
        UC7["💳 Thanh toán<br/>(MoMo/VNPAY)"]
        UC8["📦 Quản lý đơn hàng"]
        UC9["↩️ Yêu cầu hoàn trả"]
        UC10["❤️ Wishlist"]
    ...
    subgraph AdminUC["📋 Use Cases - Admin"]
        ...
        UA3["📦 Quản lý sản phẩm"]
        UA4["📂 Quản lý danh mục"]
        UA5["🚚 Quản lý shipping"]
        UA6["🎫 Quản lý coupons"]
        UA7["⚡ Quản lý flash sales"]
        UA8["📝 Quản lý nội dung"]
        UA9["✅ Kiểm duyệt"]
        UA10["💬 Messages/Newsletter"]
    end
...
```mermaid
flowchart TD
    subgraph ActorsApp["🎭 Actors"]
        AppGuest["👤 Khách hàng<br/>(chưa đăng nhập)"]
        AppAuth["👤 Khách hàng<br/>(đã đăng nhập)"]
        AppAdmin["👑 Admin"]
    end

    subgraph AppGuestUC["📋 Use Cases - Guest"]
        AU1["🏠 Home"]
        AU2["🔍 Browse + Filter"]
        AU3["📱 PDP"]
    end

    subgraph AppAuthUC["📋 Use Cases - Auth"]
        AL1["💬 Shop Q&A"]
        AL2["⭐ Reviews"]
        AL3["❤️ Wishlist"]
        AL4["🛒 Cart"]
    ...
    subgraph AppAdminUC["📋 Use Cases - Admin"]
        AA1["📊 Dashboard"]
        AA2["📦 Products"]
        AA3["📦 Inventory"]
        AA4["📦 Orders"]
...
```mermaid
flowchart TD
    subgraph ActorsBE["🎭 Actors"]
        Client["🌐 Client<br/>(Web/App)"]
        User["🔐 Khách hàng<br/>(Auth)"]
        AdminBE["👑 Admin"]
    end

    subgraph PublicUC["📋 Public API (Không Auth)"]
    ...
    subgraph UserAuthUC["📋 Auth API (Khách hàng)"]
        U1["👤 Profile"]
        U2["🛒 Cart"]
        U3["📦 Orders"]
        U4["↩️ Return & Refund"]
