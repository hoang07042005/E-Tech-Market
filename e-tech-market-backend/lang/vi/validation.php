...
return [
    ...
    'doesnt_start_with' => 'Trường :attribute không được bắt đầu bằng một trong những điều kiện sau: :values.',
    ...
    'min_digits' => 'Trường :attribute phải có tối thiểu :min kí tự.',
    ...
    'unique' => 'Email hoặc dữ liệu này đã tồn tại trong hệ thống.',
    ...
    'custom' => [
        'email' => [
            ...
            'exists' => 'Không tìm thấy email này.',
        ],
        'password' => [
            'confirmed' => 'Mật khẩu không trùng khớp khi nhập lại.',
