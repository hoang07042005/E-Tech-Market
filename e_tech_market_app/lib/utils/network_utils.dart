class NetworkUtils {
  static String fixDeviceUrl(String? url) {
    ...
    if (fixedUrl.startsWith('http://') || fixedUrl.startsWith('https://')) {
      fixedUrl = fixedUrl.replaceAll('localhost', '192.168.24.16');
      fixedUrl = fixedUrl.replaceAll('127.0.0.1', '192.168.24.16');
      return fixedUrl;
    }
    
    // For relative paths, append to base URL host (same as web's new URL logic)
    const baseUrl = String.fromEnvironment('API_BASE_URL', defaultValue: 'http://192.168.24.16:8000/api');
