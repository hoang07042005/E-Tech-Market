  ...
  static const List<Map<String, String>> _sections = [
    {
      ...
      'content':
          'Chúng tôi chỉ thu thập thông tin cần thiết để hoàn tất đơn hàng, giao hàng và hỗ trợ khách hàng. Thông tin này bao gồm họ tên, email, số điện thoại, địa chỉ giao hàng và dữ liệu liên quan đến lịch sử mua sắm.',
    },
    {
      'title': 'Sử dụng thông tin',
      'content':
          'Dữ liệu được sử dụng để xác nhận và hoàn tất giao dịch, gửi thông báo đơn hàng, hỗ trợ bảo hành, và cải thiện trải nghiệm trên ứng dụng. Mọi xử lý đều tuân thủ nguyên tắc tối thiểu hóa.',
    },
    {
      'title': 'Giao thức cookie',
      'content':
          'Cookies và công nghệ tương tự giúp ghi nhớ giỏ hàng, trạng thái đăng nhập và tùy chỉnh trải nghiệm. Người dùng có thể tắt cookie qua cài đặt trình duyệt; chúng tôi không theo dõi danh tính cá nhân qua cookie.',
    },
    {
      'title': 'Tiết lộ bên thứ ba',
      'content':
          'Chúng tôi chỉ chia sẻ dữ liệu với đối tác khi cần thiết cho giao dịch, vận chuyển hoặc xử lý thanh toán, và các đối tác này phải tuân thủ chính sách bảo mật tương ứng.',
    },
  ];
  ...
  static const List<Map<String, String>> _partnerRows = [
    {
      ...
      'purpose':
          'Theo dõi đơn giao nhận và thông báo trạng thái cho khách hàng.',
    },
    {
      'partner': 'Cổng thanh toán',
      'purpose':
          'Xử lý giao dịch và đối soát; chúng tôi không lưu chi tiết thẻ tín dụng nguyên bản.',
    },
    {
      'partner': 'Hạ tầng & bảo trì',
      'purpose':
          'Lưu trữ, vận hành máy chủ, nhật ký bảo mật và sao lưu dữ liệu an toàn.',
    },
  ];
  ...
  static const List<Map<String, String>> _userRights = [
    {
      ...
      'description':
          'Yêu cầu bản dữ liệu cung cấp ở định dạng có cấu trúc và phù hợp nếu quy định cho phép.',
    },
    {
      'title': 'Quyền được xóa bỏ',
      'description':
          'Yêu cầu xóa dữ liệu không cần thiết, trừ khi pháp luật yêu cầu lưu giữ.',
    },
    {
      'title': 'Quyền chỉnh sửa & làm rõ',
      'description':
          'Cập nhật sai sót trong hồ sơ cá nhân hoặc bổ sung thông tin chưa đầy đủ.',
    },
    {
      'title': 'Quyền khiếu nại',
      'description':
          'Phản ánh vấn đề xử lý không phù hợp, chúng tôi sẽ kiểm tra và trả lời theo luồng hỗ trợ.',
    },
  ];
...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  List<Map<String, String>> get _partnerRows =>
      PrivacyPolicyScreen._partnerRows;
  ...
  void _scrollToSection(int index) {
    debugPrint(
        '🔹 Scroll to section: $index, nav items: ${_navItems.length}, section keys: ${_sectionKeys.length}');
    setState(() {
    ...
    Future.delayed(const Duration(milliseconds: 100), () {
      try {
        ...
        debugPrint(
            '🔹 Section $index context: ${context != null ? "FOUND" : "NULL"}');
...
Dữ liệu không được thu thập với mục đích không rõ hoặc vượt ngoài mục tiêu nêu tại đây.''',
                  ...
                  children: [
                    const _InfoBox(
                      ...
                      description:
                          'Họ tên, email, số điện thoại, địa chỉ giao hàng và các thông tin bạn chủ động cung cấp khi đăng ký, đặt hàng hoặc liên hệ hỗ trợ.',
                    ),
                    const _InfoBox(
                      title: 'Dữ liệu kỹ thuật',
                      description:
                          'Địa chỉ IP, loại thiết bị, trình duyệt, múi giờ và nhật ký giao tiếp cơ bản với server để đảm bảo bảo mật, chống lạm dụng và tối ưu hiệu năng.',
                    ),
                  ],
                ),
                const SizedBox(height: 20),
                _buildSection('02. Sử dụng thông tin',
                    ...
                    children: const [
                      _BulletItem(
                          text:
                              'Xác nhận và hoàn thiện giao dịch mua sắm, vận chuyển, hóa đơn hoặc bảo hành.'),
                      _BulletItem(
                          text:
                              'Trao đổi tiếp nhận yêu cầu và thông báo liên quan đến tài khoản hoặc đơn đặt hàng của bạn.'),
                      _BulletItem(
                          text:
                              'Đo lường lỗi, bảo trì và cải thiện tốc độ, thiết kế trải nghiệm trên nền tảng của chúng tôi.'),
                      _BulletItem(
                          text:
                              'Tuân thủ nghĩa vụ pháp định, trả lời cơ quan có thẩm quyền khi có căn cứ hợp pháp.'),
                    ]),
                const SizedBox(height: 20),
                _buildSection('03. Giao thức cookie',
                    ...
                    children: const [
                      _Paragraph(
                          text:
                              'Trình duyệt của bạn cho phép giới hạn hoặc xóa cookie; một số tính năng của app có thể bị ảnh hưởng nhẹ.'),
                      _Paragraph(
                          text:
                              'Cookie phân tích (nếu có) chỉ được bật khi phù hợp và có thể tắt qua banner hoặc cài đặt trình duyệt.'),
                      _Paragraph(
                          text:
                              'Chúng tôi không dùng cookie để định danh cá nhân của bạn.'),
                    ],
                    isImageSection: true),
                const SizedBox(height: 20),
                _buildSection('04. Tiết lộ bên thứ ba',
                    ...
                    children: _partnerRows
                        .map((row) => _PartnerRow(
                            partner: row['partner']!, purpose: row['purpose']!))
                        .toList()),
                const SizedBox(height: 20),
                Container(
                  key: _sectionKeys[4],
                  ...
                  decoration: const BoxDecoration(
                    border: const Border(
                        top: BorderSide(color: Color(0xB5F37706), width: 1)),
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('05. Quyền của người dùng',
                          style: TextStyle(
                              fontSize: 22,
                              fontWeight: FontWeight.bold,
                              color: Theme.of(context).colorScheme.onSurface)),
