      ...
      child: Column(
        ...
        children: [
          ...
          _ConditionTile(
            ...
            description:
                'Áp dụng cho các lỗi kỹ thuật, phần cứng phát sinh không do tác động ngoại lực.',
          ),
          const SizedBox(height: 12),
          _ConditionTile(
            ...
            description:
                'Sản phẩm không trầy xước, móp méo, còn nguyên tem niêm phong của hãng.',
          ),
          const SizedBox(height: 12),
          _ConditionTile(
            icon: Icons.layers,
            ...
            description:
                'Phải có đầy đủ hộp (box), cáp sạc, sách hướng dẫn và quà tặng kèm (nếu có).',
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('An tâm trải nghiệm sản phẩm trong thời gian dài',
              style: TextStyle(
                  color: Theme.of(context)
                      .colorScheme
                      .onSurface
      ...
      child: Column(
        ...
        children: [
          ...
          const _ProcessStepItem(
              step: 1,
              title: 'Tiếp nhận',
              subtitle: 'Liên hệ hotline hoặc ghé cửa hàng trực tiếp.'),
          const SizedBox(height: 12),
          const _ProcessStepItem(
              step: 2,
              title: 'Kiểm tra',
              subtitle: 'Kỹ thuật viên giám định tình trạng máy.'),
          const SizedBox(height: 12),
          const _ProcessStepItem(
              step: 3,
              title: 'Xác nhận',
              subtitle: 'Chốt phương án đổi mới cho khách hàng.'),
          const SizedBox(height: 12),
          const _ProcessStepItem(
              step: 4,
              title: 'Đổi mới',
              subtitle: 'Bàn giao máy mới 100% nguyên seal.'),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          const _ExcludedTile(
              title: 'Lỗi do người dùng',
              description:
                  'Sản phẩm bị vào nước, rơi vỡ, cháy nổ do sử dụng sai nguồn điện.'),
          ...
          const SizedBox(height: 10),
          const _ExcludedTile(
              title: 'Mất phụ kiện/Hộp',
              description:
                  'Không còn đầy đủ phụ kiện đi kèm hoặc hộp bị rách nát, mất form.'),
          const SizedBox(height: 10),
          const _ExcludedTile(
              title: 'Biến dạng vật lý',
              description:
                  'Sản phẩm trầy xước nặng, biến dạng so với tình trạng ban đầu.'),
        ],
      ),
    );
  }
  ...
  Widget _buildSupportCard(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Cần hỗ trợ?',
            style: TextStyle(
                ...
                color: Theme.of(context)
                    ...
                    .withValues(alpha: 0.7))),
        const SizedBox(height: 8),
        Text('Chúng tôi luôn sẵn sàng giải đáp mọi thắc mắc của bạn 24/7.',
            style: TextStyle(
                color: Theme.of(context)
                    .colorScheme
                    .onSurface
        ...
        const SizedBox(height: 8),
        Text(
            _storeContact?['contact_phone']?.toString().trim().isNotEmpty ==
                    true
