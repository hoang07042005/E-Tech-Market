      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text('CHÍNH SÁCH & HỖ TRỢ KHÁCH HÀNG',
                style: TextStyle(
                    fontSize: 12,
          ...
          Row(
            children: const [
              _HeroStatCard(
                  value: '07 ngày', label: 'thời hạn yêu cầu hoàn tiền'),
              SizedBox(width: 10),
              _HeroStatCard(
                  value: '48 giờ', label: 'thời gian kiểm định sản phẩm'),
              SizedBox(width: 10),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          Expanded(
              child: Text('1. Điều kiện hoàn tiền',
                  style: TextStyle(
                      fontSize: 18,
        ...
        const SizedBox(height: 14),
        Column(
            children: eligibleItems.map((text) => _BulletRow(text)).toList()),
      ]),
    );
  }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 12),
          Expanded(
              child: Text('2. Sản phẩm không áp dụng',
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w800,
                      color: Theme.of(context).colorScheme.primary))),
        ...
        Text(
            ...
            style: TextStyle(
                ...
                height: 1.6)),
        const SizedBox(height: 16),
        const _ExcludedItemCard(
            icon: Icons.apps,
            title: 'Phần mềm & Key',
            description: 'Các loại mã kích hoạt đã được gửi hoặc sử dụng.'),
        const SizedBox(height: 12),
        const _ExcludedItemCard(
            icon: Icons.earbuds,
            title: 'Thiết bị vệ sinh cá nhân',
            description: 'Tai nghe in-ear đã bóc seal để đảm bảo vệ sinh.'),
        const SizedBox(height: 12),
        const _MinorNote(
            text:
                'Sản phẩm khuyến mãi (Clearance Sale) có ghi chú không đổi trả.'),
        const SizedBox(height: 8),
        const _MinorNote(
            text:
                'Hư hỏng do người dùng sử dụng sai cách hoặc tự ý can thiệp phần cứng.'),
      ]),
    );
  }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 12),
          Expanded(
              child: Text('3. Quy trình hoàn tiền',
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w800,
                      color: Theme.of(context).colorScheme.primary))),
        ...
        const _ProcessStep(
            ...
            title: 'Gửi yêu cầu',
            subtitle:
                'Liên hệ bộ phận CSKH qua email hoặc Hotline để thông báo tình trạng sản phẩm.'),
        const SizedBox(height: 12),
        const _ProcessStep(
            step: 2,
            title: 'Gửi hàng về trung tâm',
            subtitle:
                'Đóng gói cẩn thận và gửi sản phẩm về địa chỉ kiểm định của E-Tech Market Official.'),
        const SizedBox(height: 12),
        const _ProcessStep(
            step: 3,
            title: 'Kiểm định sản phẩm',
            subtitle:
                'Kỹ thuật viên sẽ kiểm tra lỗi trong vòng 48 giờ làm việc kể từ khi nhận hàng.'),
        const SizedBox(height: 12),
        const _ProcessStep(
            step: 4,
            title: 'Xác nhận & Hoàn tiền',
            subtitle:
                'Sau khi duyệt, chúng tôi sẽ tiến hành hoàn tiền theo phương thức bạn chọn.'),
      ]),
    );
  }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const SizedBox(width: 12),
          Expanded(
              child: Text('4. Phương thức và thời gian',
                  style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w800,
                      color: Theme.of(context).colorScheme.primary))),
          ...
          children: [
            const TableRow(children: [
              Padding(
                  ...
                  child: Text('Phương thức hoàn tiền',
                      style: TextStyle(fontWeight: FontWeight.w700))),
              Padding(
                  padding: EdgeInsets.symmetric(vertical: 12, horizontal: 12),
                  child: Text('Thời gian xử lý',
                      style: TextStyle(fontWeight: FontWeight.w700))),
            ]),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('CẦN HỖ TRỢ NGAY?',
              style: TextStyle(
                  ...
                  color: Theme.of(context).colorScheme.primary)),
          const SizedBox(height: 12),
          const Text('Đội ngũ kỹ thuật sẵn sàng hỗ trợ',
          ...
          _ContactRow(
              ...
              label: _storeContact?['contact_phone']
                          ?.toString()
                          .trim()
                          .isNotEmpty ==
                      true
          ...
          _ContactRow(
              icon: Icons.mail,
              label: _storeContact?['contact_email']
                          ?.toString()
                          .trim()
                          .isNotEmpty ==
                      true
          ...
          const SizedBox(height: 10),
          const _ContactRow(
              icon: Icons.chat_bubble_outline, label: 'Chat trực tuyến 24/7'),
          const SizedBox(height: 18),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              ...
              onPressed: () {},
              child: const Text('Gửi Ticket Hỗ Trợ',
          ...
          child:
            ...
            Text('Customer Service Center',
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.w700)),
            const SizedBox(height: 8),
            Text('Chăm sóc khách hàng chuyên nghiệp, tận tâm và đáng tin cậy.',
                style: TextStyle(
                    color: Theme.of(context)
                        .colorScheme
                        .primary
