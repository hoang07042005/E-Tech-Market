            ...
            _buildCard(
              children: [
                ...
                _buildSwitchTile(
                  ...
                  iconColor: const Color(0xFF10B981),
                  iconBgColor: const Color(0xFFECFDF5),
                  title: 'Cho phép cá nhân hóa đề xuất sản phẩm',
              ...
              children: [
                ListTile(
                  leading: Container(
                    ...
                    child: const Icon(Icons.info_outline, color: Color(0xFFA855F7), size: 20),
                  ),
                  title: const Text('Phiên bản ứng dụng', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500)),
                  trailing: const Text('v1.0.0', style: TextStyle(color: Color(0xFF64748B), fontSize: 14)),
                ),
                const Divider(height: 1, indent: 56),
                _buildActionTile(
