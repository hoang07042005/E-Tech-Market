                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Text('PREMIUM HIGH-TECH GEAR',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 10,
                ...
                children: [
                  ...
                  Expanded(
                    child: OutlinedButton(
                      ...
                      child: const Text('Liên hệ chúng tôi',
                          style: TextStyle(fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.network(
                        ...
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => Container(
                            height: 160, color: const Color(0xFFF1F5F9)),
                      ),
                    ),
                    const SizedBox(height: 16),
                    Text(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      'Những nguyên tắc định hình bản sắc và cách chúng tôi phục vụ khách hàng.',
                      style: TextStyle(
                          color: Theme.of(context).colorScheme.onSurface,
                          fontSize: 13)),
                  const SizedBox(height: 16),
                    ...
                    children: [
                      Expanded(
                          child: _buildValueCard(
                              ...
                              'Chất Lượng',
                              'Sản phẩm bền bỉ, hiệu năng ổn định, nguồn gốc rõ ràng.')),
                      const SizedBox(width: 12),
                      Expanded(
                          child: _buildValueCard(
                              ...
                              'Uy Tín',
                              'Minh bạch giá, chính sách và chăm sóc sau bán hàng.')),
                    ],
                  ),
                  const SizedBox(height: 12),
                  Row(
                    children: [
                      Expanded(
                          child: _buildValueCard(
                              ...
                              'Công Nghệ',
                              'Cập nhật xu hướng, tối ưu trải nghiệm số liên tục.')),
                      const SizedBox(width: 12),
                      Expanded(
                          child: _buildValueCard(
                              ...
                              'Khách Hàng',
                              'Đặt sự hài lòng của bạn làm trọng tâm mọi quyết định.')),
                    ],
                  ),
                ],
              ),
            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text('© 2025 E-Tech Market. Bảo lưu mọi quyền.',
                      style:
