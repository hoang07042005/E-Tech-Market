                    ...
                    errorBuilder: (context, error, stack) {
                      return const Center(
                          child: Icon(Icons.pets,
                              size: 86, color: Color(0xFFEF7A45)));
                    },
                  ),
                ),
              ],
                ...
                SizedBox(
                  ...
                  child: Image.asset(
                    ...
                    errorBuilder: (context, error, stack) {
                      return const Center(
                          child: Icon(Icons.pets,
                              size: 72, color: Color(0xFFEF7A45)));
                    },
                  ),
                ),
              ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    validator: (value) {
                                      if (value == null || value.isEmpty)
                                        return Trans.pleaseEnterPassword;
                                      return null;
                                    },
                                  ),
                                  if (_requires2FA) ...[
                                    ...
                                    TextFormField(
                                      ...
                                      maxLength: 6,
                                      decoration:
                                          _inputDecoration('Nhập mã 6 chữ số')
                                              .copyWith(
                                  ...
                                  Align(
                                    ...
                                    child: TextButton(
                                      ...
                                      child: Text(Trans.forgotPassword + '?',
                                          style: TextStyle(
                                              color: Color(0xFF6B7280))),
                                    ),
                                  ),
                            ...
                            Row(children: [
                              Expanded(
                                  child: Divider(color: Color(0xFFEDE6E0))),
                              Padding(
                                  padding: EdgeInsets.symmetric(horizontal: 12),
                                  child: Text(Trans.orText,
                                      style: TextStyle(
                                          color: Color(0xFFBDBDBD),
                                          fontWeight: FontWeight.w600,
                                          fontSize: 12))),
                              Expanded(child: Divider(color: Color(0xFFEDE6E0)))
                            ]),
                            const SizedBox(height: 20),
                            OutlinedButton.icon(
                              ...
                              label: Padding(
                                ...
                                child: Text(Trans.continueWithGoogle,
                                    style: TextStyle(
            ...
            Positioned(
              ...
              child: IconButton(
                icon: const Icon(Icons.arrow_back,
                    color: Color(0xFFEF7A45), size: 28),
                onPressed: () {
