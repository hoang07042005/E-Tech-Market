...
export default function FooterPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const contactData =
          await apiFetch<StoreContactPayload>("/api/store/contact");
  ...
  const displayAddress =
    storeContact?.warehouse_address?.trim() ||
      ...
      <div className="hfFooterInner">
        <div className="hfFooterTopGrid">
          ...
          <div id="footer-gioi-thieu">
            <img
              className="hfFooterLogoImg"
              src={darkMode ? "/logo-trang.png" : "/logo.png"}
              alt="E-TECH MARKET"
              decoding="async"
            />
            <div className="hfFooterTagline">
              Chuỗi bán lẻ công nghệ cao cấp tinh gọn. Chúng tôi cam kết tuyển
              chọn những thiết bị công nghệ chọn lọc độc đáo, chuẩn mực chất
              lượng và mang đến dịch vụ chăm sóc hậu mãi hoàn hảo nhất.
            </div>
          ...
          <div>
            ...
            <div className="hfFooterLinks">
              <Link className="hfFooterLink" to="/products?category=phone">
                Điện thoại di động
              </Link>
              <Link className="hfFooterLink" to="/products?category=laptop">
                Máy tính xách tay
              </Link>
              <Link className="hfFooterLink" to="/products?category=pc">
                Máy tính để bàn (PC)
              </Link>
              <Link className="hfFooterLink" to="/products?category=monitor">
                Màn hình máy tính
              </Link>
              <Link className="hfFooterLink" to="/products?category=printer">
                Máy in & Thiết bị phụ trợ
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="hfFooterLinks">
              <Link className="hfFooterLink" to="/contact">
                Liên hệ trực tuyến
              </Link>
              <Link className="hfFooterLink" to="/quy-dinh-bao-hanh-1-doi-1">
                Quy định bảo hành 1-đổi-1
              </Link>
              <Link className="hfFooterLink" to="/chinh-sach-hoan-tien">
          ...
          <div>
            ...
            <div className="hfFooterLinks">
              ...
              <Link className="hfFooterLink" to="/dieu-khoan-mua-hang">
                Điều khoản mua hàng
              </Link>
              <Link
                className="hfFooterLink"
                to="/chinh-sach-bao-mat-thanh-toan"
              >
                Chính sách bảo mật thanh toán
              </Link>
              <Link className="hfFooterLink" to="/giai-quyet-khieu-nai">
          ...
          <div id="footer-lien-he">
            ...
            <div className="hfFooterAddr">
              <div className="hfFooterContactBlock">
                <span className="hfFooterContactLabel">
                  Tổng đài hỗ trợ (24/7)
                </span>
                <a
                  href={`tel:${storeContact?.contact_phone || "19008888"}`}
                  className="hfFooterPhoneLink"
                >
              ...
              <div className="hfFooterContactBlock">
                ...
                <p className="hfFooterAddressText">{displayAddress}</p>
              </div>
              <div className="hfFooterContactBlock">
                <span className="hfFooterContactLabel">
        ...
        <div className="hfFooterBottomRow">
          <div>
            © 2026 {displayStoreName.toUpperCase()}. MUA SẮM TIỆN LỢI — DỊCH VỤ
            VƯỢT TRỘI.
          </div>
          ...
          <div
            className={`hfFooterSystemStatus ${maintenanceMode ? "hfMaintenance" : ""}`}
          >
            {maintenanceMode
              ? "Trạng thái hệ thống: Bảo trì"
