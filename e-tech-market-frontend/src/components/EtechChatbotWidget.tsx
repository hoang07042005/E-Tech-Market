...
export default function EtechChatbotWidget() {
  ...
  if (!isOpen) {
    return (
      <button className="etech-bot-fab" onClick={() => setIsOpen(true)}>
        <svg
          width="28"
          height="28"
          fill="none"
  ...
  return (
    <div className="etech-bot-container">
      ...
      <div className="etech-bot-messages">
              ...
              <div className={`etech-bot-extras ${isUser ? "user" : "model"}`}>
                    ...
                    {msg.products.map((p) => (
                      ...
                      >
                        ...
                        <div className="etech-bot-product-info">
                          <div className="etech-bot-product-brand">
                            {p.brand}
                          </div>
                ...
                {msg.coupon_code && (
                  <div className="etech-bot-coupon">
                    ...
                    <div>
                      <div className="etech-bot-coupon-text">
                        Mã giảm giá dành cho bạn!
                      </div>
                      <div className="etech-bot-coupon-code">
                        {msg.coupon_code}
                      </div>
                    </div>
                  </div>
        ...
        {isLoading && (
          <div
            className="etech-bot-msg-row model"
