...
export const saveAdminProduct = async <T>(
  data: FormData,
...
export const fetchAdminDeletedProductVariants = async (perPage = 50) => {
  const res = await apiFetch<any>(
    `/api/admin/products/deleted-variants?per_page=${perPage}`,
  );
...
export const fetchAdminDeletedProducts = async (perPage = 50) => {
  const res = await apiFetch<any>(
    `/api/admin/deleted-data/products?per_page=${perPage}`,
  );
...
export const fetchAdminDeletedProductNews = async (perPage = 50) => {
  const res = await apiFetch<any>(
    `/api/admin/deleted-data/product-news?per_page=${perPage}`,
  );
...
export const fetchAdminDeletedProductFaqs = async (perPage = 50) => {
  const res = await apiFetch<any>(
    `/api/admin/deleted-data/product-faqs?per_page=${perPage}`,
  );
