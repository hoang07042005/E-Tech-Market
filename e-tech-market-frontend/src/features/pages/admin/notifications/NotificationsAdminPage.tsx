  ...
  const load = useCallback(async () => {
    ...
    try {
      const d = await apiFetch<NotifRes>(
        `/notifications?per_page=30&page=${page}&status=${activeTab}`,
      );
      setRes(d);
    } catch (e) {
    ...
    <div className="notifPageContainer">
      ...
      <div className="notifPageHeader">
        <div>
          ...
          <p className="notifPageSubtitle">
            Xem và cập nhật các thông tin vận hành từ hệ thống.
          </p>
        </div>
      </div>
      ...
      <div className="notifTabsWrapper">
        <div className="notifTabs">
          ...
          >
            Thư mới
            <span className={`tabBadge ${res?.unread ? "unread" : ""}`}>
              {res?.unread || 0}
            </span>
          </button>
          <button
              ...
              <div key={i} className="notifSkeletonItem">
                ...
                <div className="skeletonContent">
                  <div
                    ...
                    style={{ width: "35%", height: 16, marginBottom: 8 }}
                  />
                  <div
                    className="admSkeletonBar"
                    style={{ width: "75%", height: 14, marginBottom: 8 }}
                  />
                  <div
                    className="admSkeletonBar"
                ...
                <div className="notifContentBox">
                  <div className="notifMetaTop">
                    ...
                    <div className="notifMetaRight">
                      <span
                        className={`notifStatusTag ${n.read_at ? "read" : "unread"}`}
                      >
