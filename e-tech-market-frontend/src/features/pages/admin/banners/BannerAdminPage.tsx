...
import {
  ...
  saveAdminBanner,
  type Banner,
} from "@/features/services/admin/banners.admin.service";
...
export default function BannerAdminPage() {
  ...
  const [pendingDeleteBanner, setPendingDeleteBanner] = useState<Banner | null>(
    null,
  );
              ...
              {banners.length === 0 ? (
                ...
                banners.map((banner) => (
                  <tr key={banner.id}>
                    ...
                    <td>
                      <code className="catSlug">{banner.link_url || "—"}</code>
                    </td>
                    <td>{banner.sort_order}</td>
                    <td>
                      <span
                        className={`catStatus ${banner.is_active ? "active" : "inactive"}`}
                      >
        ...
        <div className="catModalOverlay">
          <div className="catModal">
            ...
            <form onSubmit={handleSubmit} className="catForm">
              ...
              <div className="catFormField">
                <label>
                  ẢNH BANNER {editingBanner ? "(Chọn để thay đổi)" : "*"}
                </label>
                <input
                  type="file"
                  accept="image/*"
          ...
          pendingDeleteBanner ? (
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                ...
                <div>
                  <strong>
                    {pendingDeleteBanner.title || "Banner không tên"}
                  </strong>
                  <div style={{ color: "#6b7280", marginTop: 4 }}>
                    {pendingDeleteBanner.link_url || "Không có liên kết"}
                  </div>
