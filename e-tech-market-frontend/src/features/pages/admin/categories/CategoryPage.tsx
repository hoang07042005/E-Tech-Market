...
import {
  ...
  saveAdminCategory,
  type Category,
} from "@/features/services/admin/categories.admin.service";
    ...
    return (
      <Fragment key={cat.id}>
        <tr
          style={
            level > 0
              ? { background: `rgba(255, 255, 255, ${level * 0.02})` }
              : {}
          }
        >
          <td>
          ...
          <td>
            ...
            >
              ...
              <div
                className="catFolderIcon"
                style={{ opacity: level > 0 ? 0.7 : 1 }}
              >
                <FolderIcon />
              </div>
          ...
          <td>
            <code className="catSlug">{cat.slug}</code>
          </td>
          <td>
          ...
          <td>
            <span
              className={`catStatus ${cat.is_active ? "active" : "inactive"}`}
            >
            ...
            <tbody>
              {categories.length === 0 ? (
                ...
                categories
                  ...
                  .map((cat) => renderCategoryRow(cat, 0))
              )}
            </tbody>
          </table>
        )}
              ...
              <div className="catFormRow">
                ...
                <div className="catFormField">
                  ...
                  <div className="catToggleWrap">
                    ...
                    />
                    <label htmlFor="catStatusToggle" className="catToggleLabel">
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                ...
                <div>
                  ...
                  <div style={{ color: "#6b7280", marginTop: 4 }}>
                    {pendingDeleteCategory.parent_id
                      ? `Danh mục con của ${categories.find((c) => c.id === pendingDeleteCategory.parent_id)?.name || "..."}`
                      : "Danh mục gốc"}
                  </div>
                </div>
              </div>
