...
type ProductQnASectionProps = {
  ...
  setQnaShopOpenById: React.Dispatch<
...
export function ProductQnASection({
  ...
  return (
    <section
      className="pdpQnaPageEnd"
      id="pdp-hoi-dap"
      aria-labelledby="pdp-hoi-dap-main-title"
    >
        ...
        >
          ...
          <div className="pdpQnaAskBody">
            ...
            <p className="pdpQnaAskLead">
              Đội ngũ E-Tech Market sẽ phản hồi trong thời gian sớm nhất trong
              giờ làm việc. Câu hỏi gửi sau 22h có thể được trả lời vào sáng hôm
              sau.
            </p>
            {!buyerLoggedIn && (
              ...
              {shopQnas.map((row) => {
                ...
                return (
                  <li key={row.id} className="pdpQnaThreadItem">
                      ...
                      <div className="pdpQnaUserBlock">
                        ...
                        <div className="pdpQnaThreadActions">
                          ...
                          {hasAnswer ? (
                            ...
                            >
                              <span
                                className={`pdpQnaChevron ${shopOpen ? "pdpQnaChevron--up" : ""}`}
                                aria-hidden
                              >
                                <svg
                                  width="14"
                            ...
                            <span className="pdpQnaPendingBadge">
                              Đang chờ cửa hàng
                            </span>
                          )}
                        </div>
                    ...
                    {!hasAnswer ? (
                      <p className="pdpQnaPendingNote">
                        Đang chờ cửa hàng trả lời. Bạn có thể gửi thêm câu hỏi
                        khác phía trên.
                      </p>
                    ) : shopOpen ? (
                      <div className="pdpQnaShopRow">
                        ...
                        <div className="pdpQnaShopBlock">
                          <div className="pdpQnaShopMeta">
                            <span className="pdpQnaShopName">
                              Quản trị viên
                            </span>
                            <span className="pdpQnaShopBadge">QTV</span>
                            {row.answered_at && (
                              <time
                                className="pdpQnaShopTime"
                                dateTime={row.answered_at}
                              >
                          ...
                          <button
                            type="button"
                            className="pdpQnaActionLink"
                            onClick={() => scrollToPdpShopQnaForm()}
                          >
                            <IconQnaChatBubble aria-hidden />
                            Phản hồi
                          </button>
