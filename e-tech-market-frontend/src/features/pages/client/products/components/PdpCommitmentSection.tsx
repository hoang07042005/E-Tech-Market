  ...
  const commitmentItems = useMemo(() => {
      ...
      },
      {
        ...
        text: (
          <>
            ...
            <span className="pdpLink">đổi mới</span> nếu lỗi phần cứng nhà sản
            xuất trong thời gian quy định.
          </>
        ),
      },
      {
        ...
        text: (
          <>
            ...
            <span className="pdpLink pdpCommitLinkAccent">
              hoàn thuế VAT - Tax Refund
            </span>{" "}
            cho khách du lịch.
          </>
        ),
    ...
    const components: CommitItem[] = [
      ...
      },
      {
        ...
        text: (
          <>
            Hỗ trợ <b>đổi mới</b> nếu lỗi khi vừa nhận (DOA) theo chính sách.
            Bảo hành theo hãng/NSX.
          </>
        ),
      },
      {
    ...
    if (
      hay.includes("điện thoại") ||
      hay.includes("máy tính bảng") ||
      hay.includes("ipad") ||
      hay.includes("iphone")
    )
      return phoneTablet;
    if (
      ...
      return laptopPcMac;
    if (
      hay.includes("linh kiện") ||
      hay.includes("cpu") ||
      hay.includes("vga") ||
      hay.includes("mainboard")
    )
      return components;
    if (hay.includes("màn hình")) return monitor;
    if (
      hay.includes("âm thanh") ||
      hay.includes("tai nghe") ||
      hay.includes("loa")
    )
      return audio;
