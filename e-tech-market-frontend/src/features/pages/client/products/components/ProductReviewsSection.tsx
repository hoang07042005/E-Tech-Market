...
export function ProductReviewsSection({
  ...
  const [selectedMedia, setSelectedMedia] = useState<ReviewMediaItem | null>(
    null,
  );
    ...
    <section className="pdpReviewsSection" aria-label="Đánh giá sản phẩm">
      ...
      <div className="pdpReviewsSummary">
        <div className="pdpReviewsScore">
          ...
          <div className="pdpReviewsCount">
            {reviewStats.total} lượt đánh giá
          </div>
          <button
            type="button"
            className="pdpWriteReviewBtn"
      ...
      <div className="pdpReviewsFilters" aria-label="Lọc đánh giá theo">
        ...
        <div className="pdpReviewChips">
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "all" ? "active" : ""}`}
          ...
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "with_images" ? "active" : ""}`}
          ...
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "verified" ? "active" : ""}`}
          ...
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "star_5" ? "active" : ""}`}
            onClick={() => setReviewFilter("star_5")}
          >
            5 sao
          </button>
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "star_4" ? "active" : ""}`}
            onClick={() => setReviewFilter("star_4")}
          >
            4 sao
          </button>
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "star_3" ? "active" : ""}`}
            onClick={() => setReviewFilter("star_3")}
          >
            3 sao
          </button>
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "star_2" ? "active" : ""}`}
            onClick={() => setReviewFilter("star_2")}
          >
            2 sao
          </button>
          <button
            type="button"
            className={`pdpChip ${reviewFilter === "star_1" ? "active" : ""}`}
            onClick={() => setReviewFilter("star_1")}
          >
            1 sao
          </button>
        </div>
            ...
            <div key={r.id} className="pdpReviewItem">
              ...
              <div className="pdpReviewRight">
                <div className="pdpReviewStars">
                  ...
                  <span className="pdpReviewLabel">
                    {ratingLabel(r.rating)}
                  </span>
                </div>
                <div className="pdpReviewPills">
                  {!!r.order_id && (
                    <span className="pdpReviewPill verified">
                      Đã mua hàng tại E-Tech Market
                    </span>
                  )}
                </div>
                {r.comment && (
                  <div className="pdpReviewComment">{r.comment}</div>
                )}
                      ...
                      >
                        {item.type === "image" ? (
                          ...
                          <div className="pdpReviewMediaVideoWrap">
                            ...
                            />
                            <span
                              className="pdpReviewMediaVideoBadge"
                              aria-hidden
                            >
                              ▶
                            </span>
                ...
                <div className="pdpReviewTime">
                  <span className="pdpReviewClock" aria-hidden>
                    🕒
                  </span>
      ...
      {hasMoreReviews ? (
        <div className="pdpReviewsMore">
          ...
          >
            Xem thêm {Math.min(filteredReviews.length - visibleCount, 10)} đánh
            giá
          </button>
        </div>
      ) : null}
      ...
      {selectedMedia && (
        <div
          className="pdpReviewMediaModalOverlay"
