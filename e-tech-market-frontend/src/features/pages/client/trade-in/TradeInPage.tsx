...
const TradeInPage = () => {
  ...
  const fetchConditions = async (categoryId: number) => {
    try {
      const res = await fetch(
        `${API_BASE_URL}/api/v1/trade-in/conditions?category_id=${categoryId}`,
      );
      const data = await res.json();
      if (data.status === "success") {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      if (totalImages > 6) {
        toast.showToast({
          type: "error",
          message: "Bạn chỉ được tải lên tối đa 6 ảnh.",
        });
        return;
      }
  ...
  const submitRequest = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.showToast({
        type: "error",
        message: "Vui lòng điền đầy đủ thông tin bắt buộc và tải ảnh lên",
      });
      return;
    }
    ...
    try {
      ...
      if (data.status === "success") {
        toast.showToast({
          type: "success",
          message:
            "Yêu cầu định giá đã gửi thành công! Admin sẽ gửi email báo giá cho bạn.",
        });
        navigate("/");
      } else {
        toast.showToast({
  ...
  const isStep1Valid = () => {
    if (!selectedCategoryId || !machineName.trim() || images.length === 0)
      return false;
    ...
    <div className="ti-container">
      <div className="ti-hero">
        <h1 className="ti-title">
          Thu Cũ <span>Giá Cao</span> – Định Giá Nhanh Chóng
        </h1>
        <p className="ti-subtitle">
          Định giá máy cũ chính xác, quy trình thu mua nhanh chóng và giải ngân
          ngay tại E-Tech Market.
        </p>
      </div>
      ...
      <form onSubmit={submitRequest}>
        <div className="ti-content-grid">
          {/* Column 1: Info */}
          <div
            className={`ti-column ${step === 1 ? "ti-mobile-active" : "ti-mobile-hidden"}`}
          >
                  ...
                  <>
                    ...
                    <div className="ti-form-grid">
                        ...
                        <>
                          ...
                          <div className="ti-form-group">
                            ...
                            <input
                              ...
                              value={laptopDisk}
                              onChange={(e) => setLaptopDisk(e.target.value)}
                            />
                          </div>
                          <div className="ti-form-group">
                            ...
                            <input
                              ...
                              value={laptopVga}
                              onChange={(e) => setLaptopVga(e.target.value)}
                            />
                          </div>
                        </>
                      )}
                      ...
                      <div className="ti-form-group">
                        ...
                        <select
                          value={machineWarranty}
                          onChange={(e) => setMachineWarranty(e.target.value)}
                        >
                          <option value="">Chọn tình trạng bảo hành</option>
                          <option value="Còn bảo hành hãng">
                            Còn bảo hành hãng
                          </option>
                      ...
                      <div className="ti-form-group">
                        ...
                        <input
                          type="text"
                          placeholder="VD: Sạc, cáp, hộp..."
                          value={machineAccessories}
                          onChange={(e) =>
                            setMachineAccessories(e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div className="ti-form-group full-width">
                        ...
                        <div className="ti-upload-box">
                          ...
                          <p className="ti-upload-text-main">
                            Kéo thả ảnh vào đây hoặc click để chọn
                          </p>
                          <p className="ti-upload-text-sub">
          ...
          {/* Column 2: Conditions */}
          <div
            className={`ti-column ${step < 2 ? "ti-disabled-column" : ""} ${step === 2 ? "ti-mobile-active" : "ti-mobile-hidden"}`}
          >
            <div className="ti-col-header">
              <div className="ti-col-icon">
                <svg
              ...
              <div>
                ...
                <p className="ti-col-desc">
                  Vui lòng chọn tình trạng hiện tại của máy
                </p>
              </div>
            </div>

            <div
              className="ti-cond-list-wrapper"
              style={{
                display: "flex",
              ...
              {(() => {
                ...
                uniqueConds.forEach((c) => {
                  ...
                  if (
                    ...
                    name.includes("hiển thị") ||
                    name.includes("cảm ứng") ||
                    name.includes("ám") ||
                    name.includes("sọc") ||
                    name.includes("mực") ||
                    name.includes("điểm chết") ||
                    name.includes("lưu ảnh") ||
                    name.includes("chấm sáng") ||
                    name.includes("hở sáng") ||
                    name.includes("bụi trong màn") ||
                    name.includes("true tone") ||
                    name.includes("ép kính") ||
                    (name.includes("kính") && !name.includes("camera"))
                  ) {
                    ...
                    name.includes("touch id") ||
                    name.includes("vân tay") ||
                    name.includes("nút") ||
                    name.includes("wifi") ||
                    ...
                    name.includes("la bàn") ||
                    name.includes("gia tốc") ||
                    name.includes("con quay") ||
                    name.includes("nhận sim")
                  ) {
                    groups["Chức năng & Kết nối"].push(c);
                  } else if (
                    name.includes("main") ||
                    name.includes("ic") ||
                    name.includes("sửa chữa") ||
                    name.includes("tháo máy") ||
                    name.includes("nước") ||
                    name.includes("oxy hóa") ||
                    name.includes("nguồn") ||
                    name.includes("treo logo") ||
                    name.includes("chống nước")
                  ) {
          ...
          {/* Column 3: Contact */}
          <div
            className={`ti-column ${step < 3 ? "ti-disabled-column" : ""} ${step === 3 ? "ti-mobile-active" : "ti-mobile-hidden"}`}
          >
            <div className="ti-col-header">
              <div className="ti-col-icon">
                <svg
              ...
              <div>
                ...
                <p className="ti-col-desc">
                  Nhận kết quả định giá qua email và điện thoại
                </p>
              </div>
            </div>
            ...
            <div className="ti-security-box">
              ...
              <div className="ti-security-text">
                ...
                <p>
                  E-Tech Market cam kết bảo mật tuyệt đối thông tin cá nhân của
                  bạn và chỉ sử dụng để liên hệ về kết quả định giá.
                </p>
            ...
            <div className="ti-btn-wrapper-col3">
              <button
                type="button"
                className="ti-btn-secondary ti-btn-back"
                onClick={() => setStep(2)}
              >
                Quay lại
              </button>
      ...
      <div className="ti-redesign-process-section">
        ...
        <div className="ti-rp-steps">
          <div className="ti-rp-step theme-orange">
            ...
            <p className="ti-rp-desc">
              Điền form trực tuyến với các thông tin và hình ảnh thực tế về tình
              trạng thiết bị của bạn chỉ trong vài phút.
            </p>
          </div>
          ...
          <div className="ti-rp-step theme-yellow">
            ...
            <p className="ti-rp-desc">
              Hệ thống và chuyên viên sẽ ghi nhận yêu cầu, tiến hành kiểm tra
              tính hợp lệ của các thông tin được cung cấp.
            </p>
          </div>
          ...
          <div className="ti-rp-step theme-green">
            ...
            <p className="ti-rp-desc">
              Thiết bị được đánh giá minh bạch dựa trên tình trạng thực tế để
              đưa ra mức giá thu mua cạnh tranh nhất.
            </p>
          </div>
          ...
          <div className="ti-rp-step theme-blue">
            ...
            <p className="ti-rp-desc">
              Đơn yêu cầu được xét duyệt nhanh chóng. Mọi quyết định đồng ý hay
              từ chối đều đi kèm lý do rõ ràng.
            </p>
          </div>
          ...
          <div className="ti-rp-step theme-purple">
            ...
            <p className="ti-rp-desc">
              Nhận ngay thông báo kết quả thẩm định, mức giá chính thức và hướng
              dẫn các bước tiếp theo qua email của bạn.
            </p>
          </div>
        </div>
            ...
            <div className="ti-rb-c-item">
              <div className="ti-rb-c-icon">
                <svg
                  ...
                  strokeWidth="2"
                >
                  <path d="M16 21v-2a4 4 0 0 0-4-4H5.5"></path>
                  <polygon points="8 11 5 15 8 19"></polygon>
                  <path d="M8 3v2a4 4 0 0 0 4 4h8.5"></path>
                  <polygon points="16 13 19 9 16 5"></polygon>
                </svg>
              </div>
              <div className="ti-rb-c-text">
        ...
        <div className="ti-rb-notice">
          ...
          <ul className="ti-rb-n-list">
            <li>
              ...
              <span>
                Thông tin bạn cung cấp càng chi tiết, việc định giá càng chính
                xác.
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <span>
                Chúng tôi có quyền từ chối thu mua nếu thiết bị không đủ điều
                kiện.
              </span>
            </li>
            <li>
