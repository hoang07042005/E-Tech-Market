...
export default function FlashSaleSection() {
  ...
  if (loading || !activeSale || !isCurrentlyActive || !isValidTime || !hasItems)
    return null;
        ...
        <div className="flashSaleGrid">
          {(activeSale.items || [])
            ...
            .map((item) => {
              ...
              let progressPercent =
                quantityLimit > 0 ? (soldQuantity / quantityLimit) * 100 : 0;
                ...
                <Link key={item.id} to={productUrl} className="flashSaleCard">
                  ...
                  <div className="flashSaleInfo">
                    ...
                    <div className="flashSaleBottom">
                      <span className="flashSalePrice">
                        {Number(item.flash_sale_price).toLocaleString()}đ
                      </span>

                      <div
                        className={`flashSaleProgressWrapper ${isHot ? "is-hot" : ""}`}
                      >
                        <div className="flashSaleProgress">
                          <div
                            className="progressFill"
                            style={{
                              width: `${progressPercent === 0 ? 5 : progressPercent}%`,
                            }}
                          ></div>
                        </div>
