...
export default function RefundPolicyPage() {
  ...
  const displayPhone =
    storeContact?.contact_phone?.trim() || "1900 8181 (8:00 - 21:00)";
  const displayEmail =
      ...
      <div className="refundContainer">
        ...
        <div className="refundHero">
          ...
          <p className="refundLead">
            Cập nhật lần cuối: 24 tháng 5, 2024. {displayStoreName} cam kết hỗ
            trợ khách hàng một cách minh bạch, nhanh chóng và rõ ràng.
          </p>
        ...
        <div className="refundLayout">
          <div className="refundMain">
            <section className="sectionCard">
              ...
              <p className="sectionText">
                Chúng tôi cam kết mang lại sự hài lòng tuyệt đối. Bạn có thể yêu
                cầu hoàn tiền nếu đáp ứng các tiêu chí sau:
              </p>
            ...
            <section className="sectionCard">
              <div className="sectionHeader">
                ...
                <div>
                  <p className="sectionLabel">
                    2. Sản phẩm không được hoàn tiền
                  </p>
              ...
              <p className="sectionText">
                Một số mặt hàng đặc thù sẽ không được áp dụng chính sách hoàn
                tiền trừ khi có lỗi kỹ thuật nghiêm trọng:
              </p>
                    ...
                    <span className="excludedIcon">
                      <svg viewBox="0 0 24 24" aria-hidden="true">
                        <path
                          d={
                            item.icon === "apps"
                              ? "M4 5h4v4H4zM10 5h4v4h-4zM16 5h4v4h-4zM4 11h4v4H4zM10 11h4v4h-4zM16 11h4v4h-4zM4 17h4v4H4zM10 17h4v4h-4zM16 17h4v4h-4z"
                              : "M7 7h10v10H7zM9 3v4M15 3v4M9 17v4M15 17v4M3 9h4M17 9h4M3 15h4M17 15h4"
                          }
                          fill="none"
                          stroke="currentColor"
                          strokeWidth="1.8"
              ...
              <ul className="sectionList compact">
                ...
                <li>
                  Hư hỏng do người dùng sử dụng sai cách hoặc tự ý can thiệp
                  phần cứng.
                </li>
              </ul>
            </section>
          ...
          <aside className="refundAside">
            <div className="supportCard">
              ...
              <p>
                Đội ngũ của chúng tôi luôn sẵn sàng giải đáp mọi thắc mắc về quy
                trình hoàn tiền, đổi trả và các vấn đề liên quan.
              </p>
              ...
              <button type="button" className="supportBtn">
                Gửi Ticket Hỗ Trợ
              </button>
            </div>
            ...
            <div className="relatedCard">
              ...
              <div className="relatedLinks">
                <a href="/dieu-khoan">
                  Điều khoản dịch vụ <span>→</span>
                </a>
                <a href="/chinh-sach-bao-mat">
                  Bảo mật thanh toán <span>→</span>
                </a>
            ...
            <div className="imageCard">
              <div className="imageCardOverlay">
                ...
                <span>
                  Chăm sóc khách hàng chuyên nghiệp, tận tâm và đáng tin cậy.
                </span>
              </div>
            </div>
          </aside>
...
function IconPhone() {
  return (
    <svg
      ...
      strokeLinejoin="round"
      aria-hidden="true"
      style={{ color: "var(--et-primary, #904d00)" }}
    >
