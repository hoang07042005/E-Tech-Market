...
const TERMS_SIDEBAR_IMAGE_URL =
  (
    import.meta.env.VITE_TERMS_SIDEBAR_IMAGE_URL as string | undefined
  )?.trim() ||
...
export default function TermsOfServicePage() {
  ...
  function acceptTerms() {
    ...
    if (ref.includes(window.location.host) && window.history.length > 1)
      navigate(-1);
    else navigate("/");
  }
      ...
      <header className="tosHero">
        <div className="tosHeroInner">
          ...
          <p className="tosHeroMeta">
            Cập nhật lần cuối: 24 tháng 10, 2026. Vui lòng đọc kỹ các điều khoản
            này trước khi sử dụng nền tảng E-TECH MARKET.
          </p>
        </div>
      </header>
          ...
          <article className="tosArticle">
            <section id="tos-s1" className="tosSection">
              ...
              <div className="tosProse">
                <p>
                  E-TECH MARKET vận hành cửa hàng trực tuyến và các kênh dịch vụ
                  liên quan nhằm cung cấp sản phẩm công nghệ và trải nghiệm mua
                  sắm rõ ràng, minh bạch cho người dùng. Khi truy cập hoặc đặt
                  hàng qua website, bạn đồng ý tuân thủ các điều khoản dịch vụ
                  này cùng chính sách bảo mật đi kèm.
                </p>
                <p>
                  Để tiếp tục, bạn được giả định đã đủ năng lực pháp lý và năng
                  lực hành vi dân sự theo quy định hiện hành. Nếu bạn là người
                  dùng đại diện cho tổ chức, bạn khẳng định mình được ủy quyền
                  ràng buộc tổ chức đó với các điều khoản dưới đây.
                </p>
              </div>
              <div className="tosBanner" role="presentation">
                <img src={TERMS_BANNER_IMAGE_URL} alt="" loading="lazy" />
                <div className="tosBannerOverlay">
                  <span className="tosBannerTag">
            ...
            <section id="tos-s2" className="tosSection">
              ...
              <ul className="tosIconList">
                <li className="tosIconItem">
                  ...
                  <div>
                    <h3 className="tosIconItemTitle">
                      Tính chính xác của thông tin
                    </h3>
                    <p className="tosIconItemDesc">
                      Thông tin đăng ký, địa chỉ giao hàng và liên lạc cần trung
                      thực. Sai lệch có thể ảnh hưởng đến xử lý đơn hàng, hoàn
                      tiền hoặc bảo hành.
                    </p>
                  </div>
                </li>
                <li className="tosIconItem">
                  ...
                  <div>
                    ...
                    <p className="tosIconItemDesc">
                      Bạn chịu trách nhiệm bảo mật phiên đăng nhập, mật khẩu và
                      thông tin xác thực của mình, không chia sẻ cho bên thứ ba.
                      Hãy thông báo cho chúng tôi ngay khi có dấu hiệu chiếm
                      dụng tài khoản trái phép.
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <section id="tos-s3" className="tosSection">
              ...
              <div className="tosQuotePanel">
                <blockquote>
                  &ldquo;Sự chính xác là nền tảng của bản sắc thương hiệu chúng
                  tôi.&rdquo;
                </blockquote>
                <div className="tosProse">
                  <p>
                    Mọi nội dung hiển thị — bao gồm nhãn hiệu, giao diện, logo,
                    ảnh sản phẩm được chọn lọc, mô tả bố cục trang và tài nguyên
                    số — đều thuộc quyền sở hữu của E-TECH MARKET hoặc bên được
                    cấp phép phù hợp. Không được sao chép, hiểu sai lệch là tài
                    nguyên thương mại tự do nếu không có văn bản đồng ý của
                    chúng tôi.
                  </p>
                </div>
              </div>
            ...
            <section id="tos-s4" className="tosSection">
              ...
              <div className="tosProse">
                <p>
                  Trong giới hạn pháp luật cho phép, chúng tôi không chịu trách
                  nhiệm với các tổn thất gián tiếp hay hệ quả (ví dụ mất dữ
                  liệu, gián đoạn kinh doanh) phát sinh từ việc ngắt kết nối
                  mạng, thiết bị kết cuối, hoặc hành vi của bệ phóng và dịch vụ
                  bên thứ ba tích hợp không do chúng tôi trực tiếp kiểm soát.
                </p>
              </div>
              <div className="tosRiskGrid">
                ...
                <div className="tosRiskCard">
                  <IconXCircle />
                  <div>
                    <p className="tosRiskTitle">
                      Hành vi nền tảng của bên thứ ba
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="tos-s5" className="tosSection">
              ...
              <div className="tosProse">
                <p>
                  Các điều khoản này được giải thích và điều chỉnh theo luật
                  pháp Việt Nam. Tranh chấp (nếu có) ưu tiên được giải quyết
                  thông qua đối thoại và thương lượng; trường hợp không đạt,
                  thẩm quyền giải quyết thuộc tòa án có thẩm quyền theo quy
                  định.
                </p>
              </div>
            </section>
