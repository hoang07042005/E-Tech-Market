...
const CONTACT_BANNER_URL =
  (
    import.meta.env.VITE_CONTACT_BANNER_IMAGE_URL as string | undefined
  )?.trim() ||
...
export default function ContactPage() {
  ...
  const displayStoreName =
    storeContact?.store_name?.trim() || FALLBACK_STORE_NAME;
  const displayAddress =
    storeContact?.warehouse_address?.trim() || FALLBACK_ADDRESS;
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      ...
      setSubmitError(
        e2 instanceof Error ? e2.message : "Gửi liên hệ thất bại.",
      );
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="ctInner">
        <section className="ctHero" aria-label="Liên hệ E-Tech Market">
          ...
          <div className="ctHeroTopTag">
            <span
              style={{ color: "#f97316", marginRight: 8, fontSize: "1.2em" }}
            >
              ➢
            </span>
          ...
          <div className="ctHeroContent">
            ...
            <p className="ctHeroLead">
              Đội ngũ chuyên nghiệp của {displayStoreName} luôn sẵn sàng giải
              đáp mọi thắc mắc của bạn và cung cấp dịch vụ tốt nhất.
            </p>
          </div>
        </section>
          ...
          <div className="ctCard">
            <div className="ctCardPad">
              ...
              >
                ...
                <h2 className="ctCardTitle" style={{ margin: 0 }}>
                  Gửi tin nhắn cho chúng tôi
                </h2>
              </div>
              <p className="ctCardSub">
                Hãy để lại thông tin, chúng tôi sẽ phản hồi bạn trong vòng 24
                giờ làm việc.
              </p>
              ...
              <form onSubmit={onSubmit}>
                <div className="ctFormGrid">
                  <div className="ctField">
                    <label className="ctLabel">
                      Họ và tên <span className="ctRequired">*</span>
                    </label>
                    <div className="ctInputWrapper">
                      <span className="ctInputIcon">
                        <IconUser />
                      </span>
                      <input
                  ...
                  <div className="ctField">
                    <label className="ctLabel">
                      Địa chỉ email <span className="ctRequired">*</span>
                    </label>
                    <div className="ctInputWrapper">
                      <span className="ctInputIcon">
                        <IconMailForm />
                  ...
                  <div className="ctField">
                    <label className="ctLabel">
                      Số điện thoại <span className="ctRequired">*</span>
                    </label>
                    <div className="ctInputWrapper">
                      <span className="ctInputIcon">
                        <IconPhoneForm />
                  ...
                  <div className="ctField">
                    <label className="ctLabel">
                      Chủ đề <span className="ctRequired">*</span>
                    </label>
                    <div className="ctInputWrapper">
                      <select
                        className="ctSelect"
                  ...
                  <div className="ctField ctFieldFull">
                    <label className="ctLabel">
                      Nội dung tin nhắn <span className="ctRequired">*</span>
                    </label>
                    <textarea
                ...
                {submitted && (
                  <div className="ctSuccess">
                    Đã gửi yêu cầu. Chúng tôi sẽ liên hệ bạn sớm.
                  </div>
                )}
                {submitError && (
                  <div
              ...
              <div className="ctCardPad">
                ...
                <div className="ctInfoRow">
                  ...
                  <div>
                    ...
                    <p className="ctInfoVal">Thứ 2 - Chủ nhật: 8:00 - 22:00</p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    className="ctSocialRow"
                    aria-label="Liên kết mạng xã hội"
                  >
                    <button
                      type="button"
                      className="ctSocialBtn"
                      aria-label="Facebook"
                    >
                      <IconFacebook />
                    </button>
...
function IconZalo() {
  return <span style={{ fontWeight: "bold", fontSize: "12px" }}>Z</span>;
}
...
function IconTikTok() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.01.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v7.2c0 1.25-.13 2.54-.69 3.69-.97 1.98-2.92 3.42-5.12 3.8-2.22.38-4.6-.04-6.39-1.44-2.15-1.67-3.23-4.52-2.61-7.18.57-2.45 2.45-4.51 4.88-5.3 1.34-.44 2.82-.48 4.2-.18V12.7c-1.13-.19-2.31.02-3.24.69-1.2.85-1.83 2.37-1.61 3.82.2 1.25.99 2.4 2.1 3.01 1.2.66 2.7.67 3.91.07 1.35-.67 2.18-2.13 2.18-3.66V0h3.84zM12.525.02" />
    </svg>
  );
}
