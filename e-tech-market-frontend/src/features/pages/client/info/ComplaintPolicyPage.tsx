...
function BreadcrumbIcon() {
  return (
    <svg
      className="complaintBreadcrumbIcon"
      viewBox="0 0 24 24"
      aria-hidden="true"
    >
      <path
...
function Icon({ name }: { name: string }) {
  const iconMap: Record<string, ReactNode> = {
    contact_support: (
      <path
        d="M17 9a4 4 0 1 0-8 0 4 4 0 0 0 4 4v2"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
    ...
    lightbulb: (
      <path
        d="M9 18h6M10 21h4M12 3a6 6 0 0 0-4 10.9V16h8v-2.1A6 6 0 0 0 12 3z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
    ...
    verified_user: (
      <path
        d="M12 3l7 3v5c0 4.2-2.8 8-7 9-4.2-1-7-4.8-7-9V6l7-3z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
    ...
    phone_in_talk: (
      <path
        d="M5 5a2 2 0 0 1 2-2h1.4a1 1 0 0 1 .95.68l1 2.8a1 1 0 0 1-.28.96L8 9s.9 2 2 3l1.6-1.6a1 1 0 0 1 .96-.28l2.8 1a1 1 0 0 1 .68.95V17a2 2 0 0 1-2 2h-1c-4.9 0-9-4.1-9-9v-1z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="complaintIconSvg">
      {iconMap[name]}
    </svg>
  );
}
      ...
      <div className="complaintContainer">
        <section className="complaintHeroCard">
          <div className="complaintHeroContent">
            ...
            <div className="complaintEyebrow">
            ...
            <p className="complaintLead">
              ...
              Chúng tôi cam kết lắng nghe và giải quyết mọi vướng mắc một cách
              công bằng, nhanh chóng và minh bạch nhất.
            </p>
        ...
        <div className="complaintLayout">
          <div className="complaintMain">
            <section className="complaintCard">
              ...
              <p className="complaintText">
                {displayStoreName} luôn coi trọng mọi ý kiến đóng góp và khiếu
                nại từ khách hàng. Chúng tôi hiểu rằng trong quá trình vận hành
                các thiết bị công nghệ phức tạp, đôi khi sẽ có những trải nghiệm
            ...
            <section className="complaintCard complaintTimelineCard">
              ...
              <p className="complaintText">
                Mọi khiếu nại thông thường sẽ được xử lý dứt điểm trong vòng{" "}
                <strong>3 đến 7 ngày làm việc</strong>. Đối với các trường hợp
                phức tạp liên quan đến nhà sản xuất quốc tế hoặc lỗi kỹ thuật
                sâu, chúng tôi sẽ thông báo cụ thể lộ trình xử lý cho quý khách.
              </p>
            </section>
          </div>
          ...
          <aside className="complaintAside">
            ...
            <div className="complaintSidebarCard complaintNeedHelpCard">
              ...
              <p className="complaintText">
                Hãy gửi yêu cầu chi tiết để chúng tôi có thể giúp đỡ bạn nhanh
                nhất.
              </p>
            ...
            <div className="complaintBentoCard">
              ...
              <p>
                Chúng tôi liên kết trực tiếp với các trung tâm bảo hành từ
                Apple, Samsung, Dell...
              </p>
            </div>
          </aside>
