...
const PP_BANNER_IMAGE_URL =
  (
    import.meta.env.VITE_PRIVACY_BANNER_IMAGE_URL as string | undefined
  )?.trim() ||
...
const PP_SPLIT_IMAGE_URL =
  (
    import.meta.env.VITE_PRIVACY_SPLIT_IMAGE_URL as string | undefined
  )?.trim() ||
      ...
      <header className="ppHero">
        <div className="ppHeroInner">
          ...
          <p className="ppHeroLead">
            E-TECH MARKET cam kết đảm bảo tính toàn vẹn và minh bạch đối với dữ
            liệu của bạn. Chính sách này mô tả cách chúng tôi thu thập, sử dụng,
            lưu trữ và bảo vệ thông tin cá nhân khi bạn sử dụng website và dịch
            vụ của chúng tôi.
          </p>
          ...
          <aside className="ppAside">
            ...
            <div className="ppCtaOrange">
              ...
              <p className="ppCtaText">
                Đội ngũ hỗ trợ của chúng tôi sẵn sàng giải đáp thắc mắc về quyền
          ...
          <article className="ppArticle">
            <section id="pp-s1" className="ppSection">
              ...
              <div className="ppProse">
                <p>
                  Chúng tôi chỉ thu thập các loại thông tin cần thiết để cung
                  cấp dịch vụ cửa hàng: xử lý đơn hàng, giao nhận, hỗ trợ khách
                  hàng và cải thiện trải nghiệm. Dữ liệu không được thu thập với
              ...
              <div className="ppCardGrid2">
                <div className="ppInfoCard">
                  ...
                  <div>
                    ...
                    <p className="ppInfoCardDesc">
                      Họ tên, email, số điện thoại, địa chỉ giao hàng và các
                      thông tin bạn chủ động cung cấp khi đăng ký, đặt hàng hoặc
                      liên hệ hỗ trợ.
                    </p>
                  </div>
                </div>
                <div className="ppInfoCard">
                  ...
                  <div>
                    ...
                    <p className="ppInfoCardDesc">
                      Địa chỉ IP, loại thiết bị, trình duyệt, múi giờ và nhật ký
                      giao tiếp cơ bản với server để đảm bảo bảo mật, chống lạm
                      dụng và tối ưu hiệu năng.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section id="pp-s2" className="ppSection">
              ...
              <div className="ppProse">
                <p>
                  Thông tin được xử lý trên nguyên tắc tối thiểu hóa, đúng mục
                  đích và được bảo vệ bằng các biện pháp kỹ thuật, tổ chức hợp
                  lý trong phạm vi cho phép của pháp luật.
                </p>
              </div>
              <div className="ppMutedBox">
                <ul className="ppBulletList">
                  <li>
                    Xác nhận và hoàn thiện giao dịch mua sắm, vận chuyển, hóa
                    đơn hoặc bảo hành.
                  </li>
                  <li>
                    Trao đổi tiếp nhận yêu cầu và thông báo liên quan đến tài
                    khoản hoặc đơn đặt hàng của bạn.
                  </li>
                  <li>
                    Đo lường lỗi, bảo trì và cải thiện tốc độ, thiết kế trải
                    nghiệm trên nền tảng của chúng tôi.
                  </li>
                  <li>
                    Tuân thủ nghĩa vụ pháp định, trả lời cơ quan có thẩm quyền
                    khi có căn cứ hợp pháp.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section id="pp-s3" className="ppSection">
              ...
              <div className="ppSplit">
                <div className="ppProse">
                  <p>
                    Chúng tôi có thể sử dụng cookie và công nghệ tương tự để ghi
                    nhớ phiên làm việc (ví dụ giỏ hàng, trạng thái đăng nhập) và
                    để đối chiếu lưu vực không nhận biết cá nhân. Trình duyệt
                    của bạn cho phép giới hạn hoặc xóa cookie; một số tính năng
                    của site có thể bị ảnh hưởng nhẹ.
                  </p>
                  <p>
                    Cookie phân tích (nếu có) chỉ được bật khi phù hợp và có thể
                    tắt qua banner hoặc cài đặt trong trình duyệt. Chúng tôi
                    không bán định danh cá nhân của bạn.
                  </p>
                </div>
            ...
            <section id="pp-s4" className="ppSection">
              ...
              <div className="ppProse">
                <p>
                  Việc chia sẻ dữ liệu với nhà cung cấp dịch vụ chỉ diễn ra khi
                  thực sự cần cho luồng giao dịch hoặc vận hành và theo thoả
                  thuận bảo vệ ngang bằng với mức tối thiểu ghi nhận tại đây.
                </p>
              </div>
                ...
                <table className="ppTable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        Tạo và theo dõi vận đơn giao nhận, thông báo trạng thái
                        đến khách.
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        Xử lý giao dịch thẻ / ví đã được chứng nhận; chúng tôi
                        không lưu chi tiết thẻ nguyên bản.
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">Hạ tầng &amp; bảo trì</th>
                      <td>
                        Lưu trữ và vận hành máy chủ, nhật ký an ninh và sao lưu
                        dự phòng an toàn.
                      </td>
                    </tr>
                  </tbody>
            ...
            <section id="pp-s5" className="ppSection">
              ...
              <div className="ppProse">
                <p>
                  Bạn có thể liên hệ chúng tôi để thực hiện các quyền sau trong
                  phạm vi luật hiện hành và tính khả thi kỹ thuật.
                </p>
              </div>
              <div className="ppRightsGrid">
                <div className="ppRightsCell">
                  ...
                  <p>
                    Yêu cầu một bản dữ liệu bạn cung cấp ở định dạng có cấu trúc
                    và phù hợp nếu quy định cho phép.
                  </p>
                </div>
                <div className="ppRightsCell">
                  <h3>Quyền được xóa bỏ</h3>
                  <p>
                    Được xử lý yêu cầu xóa dữ liệu không cần thiết, trừ trường
                    hợp pháp luật yêu cầu lưu giữ.
                  </p>
                </div>
                <div className="ppRightsCell">
                  <h3>Quyền chỉnh sửa &amp; làm rõ</h3>
                  <p>
                    Cập nhật sai sót trong hồ sơ cá nhân hoặc bổ sung thông tin
                    còn chưa đầy đủ.
                  </p>
                </div>
                <div className="ppRightsCell">
                  ...
                  <p>
                    Phản ánh các vấn đề xử lý không phù hợp; chúng tôi sẽ kiểm
                    tra và phản hồi theo luồng hỗ trợ có sẵn.
                  </p>
                </div>
              </div>
            </section>
...
function IconDatabase() {
  return (
    ...
    >
      ...
      />
      <path
        d="M4.5 6.5v11c0 2 15 2 15 0v-11"
        stroke="currentColor"
        strokeWidth="1.75"
      />
      <path
