      ...
      <header className="tosHero">
        <div className="tosHeroInner">
          ...
          <p className="tosHeroMeta">
            ...
            dưới đây trước khi thực hiện giao dịch để đảm bảo quyền lợi tối ưu
            của bạn.
          </p>
        </div>
      </header>
          ...
          <article className="tosArticle">
            ...
            <section id="tos-s1" className="tosSection">
              ...
              <div className="tosProse">
                <p>
                  Điều khoản mua hàng này quy định các nguyên tắc, quyền lợi và
                  trách nhiệm của khách hàng khi thực hiện mua sắm tại e-tech
                  market. Bằng việc đặt hàng, bạn xác nhận đã đọc, hiểu và đồng
                  ý với các điều khoản này.
                </p>
                <p>
                  Chúng tôi cam kết cung cấp các sản phẩm công nghệ chính hãng,
                  đạt chuẩn chất lượng quốc tế và luôn nỗ lực mang lại trải
                  nghiệm mua sắm tốt nhất cho người dùng.
                </p>
              </div>
            ...
            <section id="tos-s2" className="tosSection">
              ...
              <ul className="tosIconList">
                <li className="tosIconItem">
                  ...
                  <div>
                    ...
                    <p className="tosIconItemDesc">
                      Tìm kiếm và thêm sản phẩm vào giỏ hàng cá nhân.
                    </p>
                  </div>
                </li>
                <li className="tosIconItem">
                ...
                <li className="tosIconItem">
                  ...
                  <div>
                    ...
                    <p className="tosIconItemDesc">
                      Hệ thống gửi email xác nhận và bắt đầu xử lý vận chuyển.
                    </p>
                  </div>
                </li>
              </ul>
              <div className="tosProse" style={{ marginTop: "24px" }}>
                <p>
                  e-tech market có quyền từ chối hoặc hủy đơn hàng nếu có dấu
                  hiệu gian lận hoặc sai sót về giá niêm yết do lỗi hệ thống.
                </p>
              </div>
            </section>
              ...
              <ul className="tosIconList">
                <li className="tosIconItem">
                  ...
                  <div>
                    ...
                    <p className="tosIconItemDesc">
                      Tất cả giá sản phẩm đã bao gồm thuế GTGT (VAT) trừ khi có
                      ghi chú khác.
                    </p>
                  </div>
                </li>
                <li className="tosIconItem">
                  ...
                  <div>
                    ...
                    <p className="tosIconItemDesc">
                      Hỗ trợ Thẻ tín dụng (Visa, Mastercard), Chuyển khoản ngân
                      hàng và các ví điện tử phổ biến (Momo, ZaloPay, VNPay).
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <section id="tos-s4" className="tosSection">
              ...
              <div className="tosProse">
                ...
                >
                  * Thời gian giao hàng có thể thay đổi tùy thuộc vào điều kiện
                  thời tiết hoặc các yếu tố khách quan từ phía đơn vị vận
                  chuyển.
                </p>
              </div>
            </section>
            ...
            <section id="tos-s5" className="tosSection">
              ...
              <div
                className="tosRiskGrid"
                style={{ gridTemplateColumns: "1fr 1fr" }}
              >
                <div
                  className="tosRiskCard"
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    ></span>
                    <h3 className="tosRiskTitle" style={{ margin: 0 }}>
                      Chính sách Đổi trả
                    </h3>
                  </div>
                  <ul
                  ...
                  >
                    ...
                    <li>
                      Không áp dụng với các sản phẩm tiêu hao hoặc phần mềm.
                    </li>
                  </ul>
                </div>
                <div
            ...
            <section id="tos-s6" className="tosSection">
              ...
              <div className="tosProse">
                <p>
                  Chúng tôi coi trọng việc bảo vệ dữ liệu cá nhân của bạn. Thông
                  tin khách hàng chỉ được sử dụng cho mục đích xác nhận đơn
                  hàng, giao nhận và nâng cao dịch vụ chăm sóc khách hàng.
                </p>
                <div
                  style={{
                    display: "flex",
            ...
            <section id="tos-s7" className="tosSection">
              ...
              <div className="tosProse" style={{ marginBottom: "24px" }}>
                <p>
                  Mọi thắc mắc về điều khoản hoặc cần hỗ trợ về đơn hàng, vui
              ...
              >
                <div className="tosRiskCard" style={{ padding: "24px" }}>
                  ...
                  <div>
                    ...
                    <p className="tosRiskTitle" style={{ fontSize: "18px" }}>
                      1900 8888
                    </p>
                  </div>
                </div>
