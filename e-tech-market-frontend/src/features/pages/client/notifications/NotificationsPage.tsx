...
function getNotifType(n: Notif): "blog" | "order" | "warning" | "system" {
  ...
  if (
    ...
    body.includes("hết hàng") ||
    body.includes("sắp hết")
  ) {
    return "warning";
  }
  return "system";
...
export default function NotificationsPage() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      const d = await apiFetch<NotifRes>(
  ...
  return (
    <div className="notifPage">
      ...
      >
        ...
        <div className="notifTitleRow">
          ...
          <div className="notifSub">
            Xem tất cả các tin tức công nghệ, cảnh báo kho và cập nhật đơn hàng
            của bạn.
          </div>
        </div>
      </div>
      ...
      {error && (
        <div className="prodErrorBanner" style={{ marginBottom: 24 }}>
          {error}
        </div>
      )}
          ...
          <div className="notifSidebarCard">
            ...
            <div className="notifFilterList">
              ...
              >
                ...
                <span
                  className={`notifFilterCount ${unreadCount > 0 ? "badge-unread" : ""}`}
                >
                  {unreadCount}
                </span>
              </button>
              ...
              >
                ...
                <span className="notifFilterCount">
                    ...
                    return (
                      ...
                      >
                        <div className="notifCardInner">
                          <div
                            className={`notifIconContainer notifIcon--${type}`}
                          >
                            {renderIcon(type)}
                          </div>
                          <div className="notifCardContent">
                            <div
                              className="notifCardHeader"
                              style={{
                                display: "flex",
                                flexDirection: "row",
                                ...
                                alignItems: "center",
                                width: "100%",
                                marginBottom: expandedNotifs.includes(n.id)
                                  ? "0"
                                  : "0",
                              }}
                            >
                              ...
                              >
                                <h3 className="notifCardTitle">
                                  {n.title || "Thông báo"}
                                </h3>
                                <div className="notifCardMeta">
                                  <span className="notifCardTime">
                                    {fmtDateTime(n.created_at)}
                                  </span>
                                  {n.read_at ? (
                                    <span className="notifBadgeRead">
                                      Đã đọc
                                    </span>
                                  ) : (
                                    <>
                              ...
                              <svg
                                ...
                                strokeLinejoin="round"
                                style={{
                                  transform: expandedNotifs.includes(n.id)
                                    ? "rotate(180deg)"
                                    : "none",
                                  transition:
                              ...
                              >
                                ...
                                {getActionUrl(n) && (
                                  <button
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      navigate(getActionUrl(n) as string);
                                    }}
                                    style={{
                                      marginTop: "12px",
                                      padding: "8px 16px",
